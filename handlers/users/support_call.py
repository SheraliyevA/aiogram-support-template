...
async def send_to_support_call(call: types.CallbackQuery, state: FSMContext, callback_data: dict):
    await call.message.edit_text("Siz texnik yordamga murojaat qildingiz. Operator javobini kuting!")
    ...
    await bot.send_message(support_id,
                           f"Foydalanuvchi siz bilan bog'lanmoqchi {call.from_user.get_mention()}",
